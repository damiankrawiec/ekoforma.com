...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 28 Mar 2020, 19:12
...
(12, 'Tytuły rzędu', 'title-row', 'display:none;', 'Tytuły są niewidoczne po załadowaniu strony - przejmuje je jQuery i wstrzykuje do pierwszego rzędu (siatka RWD)', '2020-03-28 18:47:28', '2020-03-28 18:58:52');
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=427 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(8, 'Tytuły rzędu', 'col-12', '', '2020-03-28 18:48:29', '2020-03-28 19:50:53');
...
(14, 8, 1, 'col-12 animated fadeIn', '', 1, '', '2020-03-28 18:49:18', '2020-03-28 19:51:26');

...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 14 Kwi 2020, 20:08
...
(14, 'Treść sekcji', 'content', '', 'Etykieta stosowana we wszystkich sekcjach oprócz strony głównej', '2020-04-14 19:29:03', '2020-04-14 19:29:45');
...
(28, 12, 14, 4, 'Więcej...', 'Puszyste placuszki jogurtowe', 'Puszyste placuszki jogurtowe', '<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>\r\n<p></p>', '', '', '', '', 'fal fa-tilde fa-2x text-success', 1, 'on', 'off', '', '2020-04-14', '2020-04-14 19:30:34', '2020-04-14 21:08:41'),
(29, 12, 14, 4, 'Więcej...', 'Jakaś zupinka', 'Jakaś zupinka', '<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>', '', '', '', '', 'fal fa-tilde fa-2x text-success', 1, 'on', 'off', '', '2020-04-14', '2020-04-14 20:57:20', '2020-04-14 21:08:54'),
(30, 12, 14, 4, 'Więcej...', 'Jakaś zupinka 2', 'Jakaś zupinka 2', '<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach</p>\r\n<p>Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach. Tu będzie treść opisująca dany element. M&oacute;wiąca o jego szczeg&oacute;łach.</p>', '', '', '', '', 'fal fa-tilde fa-2x text-success', 1, 'on', 'off', '', '2020-04-14', '2020-04-14 21:01:08', '2020-04-14 21:09:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(4, 0, 'Ekopaśnik', 'ekopasnik', '', '', 'container-fluid', '', 4, 'on', 'on', 'off', '', '2020-03-17 21:59:50', '2020-04-14 22:00:34'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=513 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(3, 'Ekopaśnik - strona główna', 'col-12 col-lg-4', 'on', '', '2020-03-18 18:02:36', '2020-04-14 19:19:35'),
...
(9, 'Lifestyle - strona główna', 'col-12 col-lg-4', 'on', '', '2020-03-30 10:18:36', '2020-04-14 19:19:19'),
(10, 'Podróże - strona główna', 'col-12 col-lg-4', 'on', '', '2020-03-30 10:45:54', '2020-04-14 19:18:32'),
(11, 'Tytuły w kolumnie', 'col-12', 'on', '', '2020-03-30 11:12:12', '2020-04-04 12:24:06'),
(12, 'Ekopaśnik - sekcja', 'col-12 col-xl-6', 'on', '', '2020-04-14 19:19:56', '2020-04-14 22:00:03');
...
(26, 12, 4, 'col-12 col-xl-6', '', 3, 'on', '', '2020-04-14 19:20:55', '2020-04-14 22:03:18'),
(27, 12, 1, 'col-12 text-center text-success pt-5', 'h3', 1, 'on', '', '2020-04-14 19:21:23', '2020-04-14 20:57:54'),
(28, 12, 12, 'col-12 text-center', '', 2, 'on', '', '2020-04-14 19:22:36', '2020-04-14 20:48:42'),
(29, 12, 2, 'col-12 col-xl-6', 'content-text', 4, 'on', '', '2020-04-14 19:23:05', '2020-04-14 22:03:28'),
(30, 12, 5, 'col-10 offset-1 text-center im-border-top pt-4 mt-4', 'btn btn-success', 5, 'on', '', '2020-04-14 19:23:24', '2020-04-14 22:02:13');

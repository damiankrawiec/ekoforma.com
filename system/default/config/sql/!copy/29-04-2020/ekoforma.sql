...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 29 Kwi 2020, 16:08
...
(14, 'Ekopaśnik', 'ekopasnik', '', 'Tylko dla: śniadania, dania główne, kolacje, przekąski, desery', '2020-04-29 17:03:33', '2020-04-29 17:05:02');
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=726 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;

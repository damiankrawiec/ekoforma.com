...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 30 Kwi 2020, 15:56
...
(1, 3, 'Zwierzyna (dania mięsne)', '', 1, 'on', '', '2020-04-29 17:00:49', '2020-04-29 17:38:44'),
(2, 3, 'Myśliwy (może być opis...)', '', 2, 'on', '', '2020-04-29 17:09:48', '2020-04-29 17:38:54'),
(3, 3, 'Rybak', '', 3, 'on', '', '2020-04-29 17:09:59', '2020-04-29 17:39:04');
...
(15, 'Submenu', 'submenu', NULL, NULL, '2020-04-30 08:09:29', '2020-04-30 08:09:29');
...
(42, 14, 15, 0, '', 'Submenu', '', NULL, '', '', '', '', '', 1, 'on', 'off', '', '2020-04-30', '2020-04-30 08:29:12', '2020-04-30 08:49:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=254 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(4, 0, 'Ekopaśnik', 'ekopasnik', '', '', 'container', '', 4, 'on', 'on', 'off', '', '2020-03-17 21:59:50', '2020-04-29 15:44:15'),
...
(10, 4, 'Śniadania', 'sniadania', '', 'fal fa-egg-fried fa-fw', 'container', '', 1, 'on', 'off', 'off', '', '2020-04-29 15:41:45', '2020-04-29 16:46:06'),
(11, 4, 'Dania główne', 'dania-glowne', '', 'fal fa-turkey fa-fw', 'container', '', 2, 'on', 'off', 'off', '', '2020-04-29 16:05:45', '2020-04-29 16:45:48'),
(12, 4, 'Kolacje', 'kolacje', '', 'fal fa-utensils-alt fa-fw', 'container', '', 3, 'on', 'off', 'off', '', '2020-04-29 16:11:32', '2020-04-29 16:46:23'),
(13, 4, 'Przekąski', 'przekaski', '', 'fal fa-salad fa-fw', 'container', '', 4, 'on', 'off', 'off', '', '2020-04-29 16:13:21', '2020-04-29 16:46:30'),
(14, 4, 'Desery', 'desery', '', 'fal fa-ice-cream fa-fw', 'container', '', 5, 'on', 'off', 'off', '', '2020-04-29 16:41:51', '2020-04-29 16:46:41');
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=738 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(14, 'Submenu', 'col-12', 'on', '', '2020-04-30 08:27:20', '2020-04-30 08:27:27');
...
(1, 1, 7, 'col-12 main-menu', 'navbar navbar-expand-lg navbar-light', 1, 'on', '', '2020-03-17 21:56:04', '2020-04-30 09:03:17'),
...
(34, 14, 7, 'col-12', 'navbar navbar-expand-lg navbar-light', 1, 'on', '', '2020-04-30 08:28:17', '2020-04-30 09:07:50');
